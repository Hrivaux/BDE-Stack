                                                ...
                                                <table class="table table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Échantillon</th>
                                                            <th>Avis</th>
                                                            <th><?php if ($grade_encours == 3) {echo "Modifier";}?></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if ($grade_encours == 3) { ?><a href="modifier_compterendu.php?id=<?php echo $cr['id_compterendu'];?>" class="2">Ouvrir</a></td><?php } ?>
