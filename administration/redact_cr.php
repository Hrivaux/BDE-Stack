                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="inc/actions/form_compterendu.php" method="POST" class="text-center">
                                                        ...
                                                        <div class="form-group">
                                                            <h5 class="mt-5">Motif de la visiste 1</h5>
                                                            <hr>
                                                        ...
                                                        <div class="form-group">
                                                            <h5 class="mt-5">Motif de la visiste 2</h5>
                                                            <hr>
                                                            
														<select id="id_motif2" name="id_motif2" class="form-control text-center" required>
															<?php $reponse = $bdd->query('SELECT * FROM motif_rdv');
                                                                     while ($donnees = $reponse->fetch())
									                                        { ?>
