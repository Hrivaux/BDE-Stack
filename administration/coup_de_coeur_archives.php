                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Liste des coups de coeur archivés</h5>
                                    </div>
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="">Les archives</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Coups de coeurs archivés</h5>
                                            <p>Consultez ou remettez en ligne les coups de coeur archivés.</p>
                                        </div>
                                                ...
                                                <table class="table table-hover">
													...
													");
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    <td>
                                                                        <a href="<?php echo $url; ?>inc/actions/republier_publication.php?id=<?php echo $publication['id']; ?>&titre=<?php echo $publication['titre']; ?>"><img src="img/archiver3.png" style="display:inline; width:30px; height: 30px;" /></a>
                                                                    </td>
                                                                    <td>
