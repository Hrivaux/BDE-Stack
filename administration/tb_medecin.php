												...
												<table class="table table-hover">
													<thead>
														<tr>
															...
															<td><?php if ($grade_encours == 3) {  echo "Supprimer"; } ?></td>
														</tr>
													</thead>
													<tbody>
...
if (!empty($resultat))
{
  ...
  <tr>
	...
	<td>
		...
		<td>
		<?php if ($grade_encours == 3 ) { ?><a href="inc/actions/delete_medecin.php?id=<?php echo $medecins['id'];?>" class="">Supprimer</a></td><?php } ?></td>
		</td>
	</tr>
